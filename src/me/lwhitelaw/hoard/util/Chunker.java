...
public class Chunker {
	...
	public Chunker(int bufferSize, int chunkModulus) {
		mod = chunkModulus;
	...
	public void update(int b) {
		...
		bufferIndex = (bufferIndex + 1) % ringbuffer.length; // Move to next buffer position mod buffer size, shifting history by one
	}
